...
public class DelphinusDelphis implements AnimalAbilities, LandAbilities, AerialAbilities, MarineAbilities {
    private String name;
    private int speed;
    private final int MAXIMUM_SPEED = 56;

    public DelphinusDelphis() { }

    public DelphinusDelphis(String name) {
        this.name = name;
    ...
    @Override
    public String getInformation() { return "The " + this.name + " is a marine animal and has a speed of " + this.speed + " km/h"; }
