...
public class Horse implements AnimalAbilities, LandAbilities, AerialAbilities, MarineAbilities {
    private String name;
    private int speed;
    private final int MAXIMUM_SPEED = 88;
    ...
    @Override
    public boolean swimAble() { return false; }

    @Override
    public boolean runAble() { return true; }
